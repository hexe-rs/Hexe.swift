...
public enum Piece: UInt8 {
    /** White Pawn piece.   */ case whitePawn
    /** Black Pawn piece.   */ case blackPawn
    /** White Knight piece. */ case whiteKnight
    /** Black Knight piece. */ case blackKnight
    /** White Bishop piece. */ case whiteBishop
    /** Black Bishop piece. */ case blackBishop
    /** White Rook piece.   */ case whiteRook
    /** Black Rook piece.   */ case blackRook
    /** White Queen piece.  */ case whiteQueen
    /** Black Queen piece.  */ case blackQueen
    /** White King piece.   */ case whiteKing
    /** Black King piece.   */ case blackKing
}
...
public enum PieceKind: UInt8 {
    /** Pawn kind.   */ case pawn
    /** Knight kind. */ case knight
    /** Bishop kind. */ case bishop
    /** Rook kind.   */ case rook
    /** Queen kind.  */ case queen
    /** King kind.   */ case king
}
